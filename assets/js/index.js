...
`)}function _T(t,e){let n;switch(e){case Dx:n="Linear";break;case Ux:n="Reinhard";break;case Ix:n="Cineon";break;case Nx:n="ACESFilmic";break;case Ox:n="AgX";break;case kx:n="Neutral";break;case Fx:n="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),n="Linear"}return"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const Ma=new z;function vT(){Ve.getLuminanceCoefficients(Ma);const t=Ma.x.toFixed(4),e=Ma.y.toFixed(4),n=Ma.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${t}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
